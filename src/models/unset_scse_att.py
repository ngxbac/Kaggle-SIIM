...
class Res34Unetv4(nn.Module):
    def __init__(self):
        ...
        self.encoder = torchvision.models.resnet34(True)
        ...
        self.encode2 = nn.Sequential(self.encoder.layer1,
                                     SCse(64))
        self.encode3 = nn.Sequential(self.encoder.layer2,
                                     SCse(128))
        self.encode4 = nn.Sequential(self.encoder.layer3,
                                     SCse(256))
        self.encode5 = nn.Sequential(self.encoder.layer4,
                                     SCse(512))

        self.center = nn.Sequential(FPAv2(512, 256),
                                    nn.MaxPool2d(2, 2))

        self.decode5 = DecoderAtt(256, 512, 64)
        self.decode4 = DecoderAtt(64, 256, 64)
        self.decode3 = DecoderAtt(64, 128, 64)
        self.decode2 = DecoderAtt(64, 64, 64)
